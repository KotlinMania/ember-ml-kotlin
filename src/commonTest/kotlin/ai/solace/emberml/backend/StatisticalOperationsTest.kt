...
class StatisticalOperationsTest {
    ...
    fun testMeanOperation() {
        ...
        val tensor = backend.createTensor(data, intArrayOf(5), EmberDType.FLOAT64) 
    ...
    fun testVarianceAndStd() {
        ...
        assertEquals(EmberDType.FLOAT64, varianceResult.dtype)
        ...
        assertEquals(EmberDType.FLOAT64, stdResult.dtype)
    ...
    fun testSumOperation() {
        ...
        val tensor = backend.createTensor(data, intArrayOf(5), EmberDType.INT32) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
        ...
        assertEquals(EmberDType.INT64, result.dtype)
        assertEquals(1, result.size)
        assertTrue(result.shape.contentEquals(intArrayOf()))
    }
    ...
    fun testCumSumOperation() {
        ...
        val tensor = backend.createTensor(data, intArrayOf(4), EmberDType.INT32) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
    ...
    fun testKeepDimsParameter() {
        ...
        val tensor = backend.createTensor(data, intArrayOf(4), EmberDType.FLOAT64) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
    ...
    fun testDifferentDataTypes() {
        ...
        val boolTensor = backend.createTensor(boolData, intArrayOf(5), EmberDType.BOOL) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
        
        val boolMean = statsOps.mean(boolTensor) as OptimizedMegaTensorBackend.OptimizedMegaTensor
        assertEquals(EmberDType.FLOAT64, boolMean.dtype)
        ...
        assertEquals(EmberDType.FLOAT32, floatSum.dtype)
    }
    ...
    fun testErrorHandling() {
        ...
        val emptyTensor = backend.createTensor(emptyData, intArrayOf(0), EmberDType.FLOAT64)
        ...
        val tensor = backend.createTensor(data, intArrayOf(3), EmberDType.FLOAT64)

...
class ArrayManipulationOperationsTest {
    ...
    fun testVStack() {
        ...
        val tensor1 = backend.createTensor(data1, intArrayOf(1, 2), EmberDType.FLOAT64) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
        val tensor2 = backend.createTensor(data2, intArrayOf(1, 2), EmberDType.FLOAT64) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
        val tensor3 = backend.createTensor(data3, intArrayOf(1, 2), EmberDType.FLOAT64) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
    ...
    fun testHStack1D() {
        ...
        val tensor1 = backend.createTensor(data1, intArrayOf(2), EmberDType.FLOAT64) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
        val tensor2 = backend.createTensor(data2, intArrayOf(2), EmberDType.FLOAT64) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
    ...
    fun testHStack2D() {
        ...
        val tensor1 = backend.createTensor(data1, intArrayOf(2, 2), EmberDType.FLOAT64) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
        val tensor2 = backend.createTensor(data2, intArrayOf(2, 2), EmberDType.FLOAT64) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
    ...
    fun testConcatenate1D() {
        ...
        val tensor1 = backend.createTensor(data1, intArrayOf(3), EmberDType.INT32) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
        val tensor2 = backend.createTensor(data2, intArrayOf(2), EmberDType.INT32) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
        val tensor3 = backend.createTensor(data3, intArrayOf(4), EmberDType.INT32) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
    ...
    fun testRepeatFlattened() {
        ...
        val tensor = backend.createTensor(data, intArrayOf(3), EmberDType.INT32) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
    ...
    fun testTile1D() {
        ...
        val tensor = backend.createTensor(data, intArrayOf(2), EmberDType.INT32) 
            as OptimizedMegaTensorBackend.OptimizedMegaTensor
    ...
    fun testErrorHandling() {
        ...
        val tensor1 = backend.createTensor(doubleArrayOf(1.0, 2.0), intArrayOf(1, 2), EmberDType.FLOAT64)
        val tensor2 = backend.createTensor(doubleArrayOf(3.0, 4.0, 5.0), intArrayOf(1, 3), EmberDType.FLOAT64)
        ...
        val intTensor = backend.createTensor(intArrayOf(1, 2), intArrayOf(1, 2), EmberDType.INT32)
        val floatTensor = backend.createTensor(doubleArrayOf(3.0, 4.0), intArrayOf(1, 2), EmberDType.FLOAT64)
        ...
        val tensor = backend.createTensor(intArrayOf(1, 2), intArrayOf(2), EmberDType.INT32)
    ...
    fun testUnsupportedOperations() {
        val tensor = backend.createTensor(doubleArrayOf(1.0, 2.0, 3.0, 4.0), intArrayOf(2, 2), EmberDType.FLOAT64)
    ...
    fun testDifferentDataTypes() {
        ...
        val boolTensor1 = backend.createTensor(boolData1, intArrayOf(2), EmberDType.BOOL)
        val boolTensor2 = backend.createTensor(boolData2, intArrayOf(2), EmberDType.BOOL)
        ...
        val floatTensor = backend.createTensor(floatArrayOf(1.0f, 2.0f), intArrayOf(2), EmberDType.FLOAT32)
        val intTensor = backend.createTensor(intArrayOf(3, 4), intArrayOf(2), EmberDType.INT32)
    ...
    fun testEmptyAndSingleElementOperations() {
        ...
        val singleTensor = backend.createTensor(singleData, intArrayOf(1, 2), EmberDType.FLOAT64)
        ...
        val scalarTensor = backend.createTensor(scalarData, intArrayOf(1), EmberDType.FLOAT64)

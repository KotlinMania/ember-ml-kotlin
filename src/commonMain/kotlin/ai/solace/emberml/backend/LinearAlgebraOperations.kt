...
class LinearAlgebraOperations(private val backend: OptimizedMegaTensorBackend) {
    ...
    fun determinant(tensor: Any): Any {
        ...
        setStorageValue(resultStorage, 0, det, EmberDType.FLOAT64)
    ...
    fun norm(tensor: Any, ord: String = "fro"): Any {
        ...
        when (ord) {
            "fro" -> {
                ...
                // Create scalar result
                val resultStorage = TensorStorage.createOptimalStorage(EmberDType.FLOAT64, 1)
                setStorageValue(resultStorage, 0, normValue, EmberDType.FLOAT64)
    ...
    fun inverse(tensor: Any): Any {
        ...
        when (n) {
            1 -> {
                ...
                val resultStorage = TensorStorage.createOptimalStorage(EmberDType.FLOAT64, 1)
                setStorageValue(resultStorage, 0, 1.0 / value, EmberDType.FLOAT64)
            ...
            2 -> {
                ...
                val resultStorage = TensorStorage.createOptimalStorage(EmberDType.FLOAT64, 4)
                setStorageValue(resultStorage, 0, d / det, EmberDType.FLOAT64)
                setStorageValue(resultStorage, 1, -b / det, EmberDType.FLOAT64)
                setStorageValue(resultStorage, 2, -c / det, EmberDType.FLOAT64)
                setStorageValue(resultStorage, 3, a / det, EmberDType.FLOAT64)
